...
class IndexController extends ActionController
{
    public function indexAction()
    {
		...
		$form->addElement('select', 'select',
				array('label' => 'Select', 'multiOptions' => array('da', 'ne')));
				
		$form->addElement('Radio', 'radio',
				array('label' => 'Radio', 'multiOptions' => array('da', 'ne')));
				
		$form->addElement('Checkbox', 'checkbox',
				array('label' => 'Checkbox', 'multiOptions' => array('da', 'ne')));
		
		$form->addElement('text', 'url', 
			array('label' => 'Text', 'required' => true));
		...
		$form->addElement('DatePicker', 'date', 
			array('label' => 'DatePicker', 'required' => true));
		...
		$btn = $form->addElement('submit', 'poslji', 
			array('value' => 'pošlji'));
		
		$form->addDisplayGroup(array('poslji'), 'buttons', 
			array('decorators' => array('ButtonHolder')));
